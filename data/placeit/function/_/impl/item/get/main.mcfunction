...
data modify storage placeit:out get.result.components set from storage placeit:in get.components

data modify storage placeit:_ v.get.custom_data set value {_:true,_placeit:{place_data:{present:true}}}
data modify storage placeit:_ v.get.custom_data._placeit.place_data.command set from storage placeit:in get.place.command
data modify storage placeit:_ v.get.custom_data._placeit.place_data.data set from storage placeit:in get.place.data
